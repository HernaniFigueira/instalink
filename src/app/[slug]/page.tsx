...
export default async function PublicPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className={`il-page min-h-screen${btnStyle}`}>
      ...
      <div
        className="mx-auto w-full max-w-md px-4 pt-4 space-y-7"
        ...
        <section>
          ...
          <div className={business.cover ? 'px-1 -mt-12' : 'px-1 pt-2'}>
            ...
            <div className="text-center mt-2.5">
              <h1 className="text-[25px] leading-tight font-extrabold tracking-tight">{business.name}</h1>
              {business.description && <p className="il-muted text-sm mt-1.5 max-w-sm mx-auto leading-snug">{business.description}</p>}
