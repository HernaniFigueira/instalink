                  ...
                  <div key={k.id} className="p-4 flex flex-wrap items-center justify-between gap-3 hover:bg-zinc-50/50">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {k.revokedAt ? (
                          <span className="bg-red-100 text-red-700 text-[10px] px-2 py-0.5 rounded font-semibold uppercase tracking-wide">
                            Revogada
                          </span>
                        ) : (
                          <span className="bg-emerald-100 text-emerald-700 text-[10px] px-2 py-0.5 rounded font-semibold uppercase tracking-wide">
                            Ativa
                          </span>
                        )}
                      </div>
                  ...
                  <div key={hook.id} className="p-4 border border-zinc-200 rounded-xl space-y-3 hover:bg-zinc-50/50">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="min-w-0 flex-1">
                        <span className="font-mono text-xs font-semibold text-zinc-900 break-all">{hook.url}</span>
        ...
        <div className="space-y-4">
          <section className="bg-white border border-zinc-200 p-5 rounded-xl space-y-4">
            ...
            <div className="space-y-1.5">
              <span className="text-xs font-semibold uppercase tracking-wider text-zinc-700">1. Link Direto (Deep Link)</span>
            ...
            <div className="space-y-1.5 pt-3 border-t border-zinc-100">
              <span className="text-xs font-semibold uppercase tracking-wider text-zinc-700">2. Código Incorporado (Iframe HTML)</span>
            ...
            <div className="space-y-1.5 pt-3 border-t border-zinc-100">
              <span className="text-xs font-semibold uppercase tracking-wider text-zinc-700">3. Código Widget (Script)</span>
            ...
            {generatedSecret ? (
              <div className="space-y-4">
                <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-amber-900 text-xs space-y-1">
                  <p className="font-semibold">⚠️ Copie sua chave de API agora!</p>
