...
const PATHS: Record<string, React.ReactNode> = {
  ...
  paw: (<><ellipse cx="12" cy="15.5" rx="4" ry="3.2" /><circle cx="5.6" cy="10.6" r="1.7" /><circle cx="9.4" cy="7.4" r="1.7" /><circle cx="14.6" cy="7.4" r="1.7" /><circle cx="18.4" cy="10.6" r="1.7" /></>),
  ...
  // A3.4 · Bloco 7 — baixar arquivo (exportar a base).
  download: (<><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="M7 10l5 5 5-5" /><path d="M12 15V3" /></>),
  // A3.4 · Bloco 5 — registro do atendimento (documento) e impressão.
  fileText: (<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M9 13h6" /><path d="M9 17h4" /></>),
  ...
  /* ── GoDoutor UI Revolution · Etapa A/B — shell, sheet e preview ──
     Sino de notificação, chevron de breadcrumb/segunda coluna, minimizar do
     Workspace Sheet e os dois alvos do preview do editor (Mobile | Desktop). */
  bell: (<><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></>),
  chevronRight: (<path d="m9 18 6-6-6-6" />),
  help: (<><circle cx="12" cy="12" r="9.5" /><path d="M9.6 9.2a2.6 2.6 0 1 1 3.4 2.5c-.7.3-1 .9-1 1.6v.4" /><path d="M12 17.2h.01" /></>),
